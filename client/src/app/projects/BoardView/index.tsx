...
const TaskColumn = ({
  ...
  return (
    <div
      ...
      className={`rounded-lg py-2 selection:py-4 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neutral-950" : ""} `}
    >
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              className="flex h-6 w-6 items-center justify-center rounded-none bg-gray-200 dark:bg-dark-tertiary dark:text-white"
  ...
  return (
    ...
    >
      ...
      <div className="p4 md:p-6">
        ...
        <div className="mt-4 border-t border-gray-500 dark:border-stroke-dark">
          {/* Users */}
